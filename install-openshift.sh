...
ansible-playbook -i inventory.ini openshift-ansible/playbooks/prerequisites.yml  || exit 1
ansible-playbook -i inventory.ini openshift-ansible/playbooks/deploy_cluster.yml || exit 1
